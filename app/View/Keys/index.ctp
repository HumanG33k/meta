<div class="keys index">
	...
	<tr>
		...
		<td><?php echo h($key['Key']['description']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $key['Key']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $key['Key']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $key['Key']['id']), array(), __('Are you sure you want to delete # %s?', $key['Key']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
