<div class="entities index">
	...
	<tr>
		...
		<td><?php echo h($entity['Entity']['updated']); ?>&nbsp;</td>
		<td><?php echo h($entity['Entity']['created']); ?>&nbsp;</td>
		<td><?php echo h($entity['Entity']['syntax']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $entity['Entity']['id']), array(), __('Are you sure you want to delete # %s?', $entity['Entity']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
